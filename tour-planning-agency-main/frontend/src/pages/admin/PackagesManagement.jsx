                  ...
                  <div className={formTab === 'basic' ? 'block' : 'hidden'}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="md:col-span-2">
                        ...
                        <input type="text" required value={formData.title} onChange={e => setFormData({...formData, title: e.target.value})} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="e.g. Majestic Dubai 5 Days" />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Destination *</label>
                        <input type="text" required value={formData.destination} onChange={e => setFormData({...formData, destination: e.target.value})} className="w-full px-3 py-2 border rounded-lg" placeholder="e.g. Dubai" />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Country *</label>
                        <input type="text" required value={formData.country} onChange={e => setFormData({...formData, country: e.target.value})} className="w-full px-3 py-2 border rounded-lg" placeholder="e.g. UAE" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input type="text" value={formData.duration} onChange={e => setFormData({...formData, duration: e.target.value})} className="w-full px-3 py-2 border rounded-lg" placeholder="Leave blank to auto-generate (e.g. 5D/4N)" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={formTab === 'pricing' ? 'block' : 'hidden'}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input type="number" min="0" value={formData.originalPrice} onChange={e => setFormData({...formData, originalPrice: e.target.value})} className="w-full px-3 py-2 border rounded-lg" placeholder="For strikethrough effect" />
                      </div>
                      <div>
                  ...
                  <div className={formTab === 'content' ? 'block' : 'hidden'}>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <textarea required value={formData.shortDescription} onChange={e => setFormData({...formData, shortDescription: e.target.value})} className="w-full px-3 py-2 border rounded-lg h-20 resize-none" placeholder="A brief 1-2 sentence overview..."></textarea>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Detailed Description (For Package Page)</label>
                        <textarea value={formData.detailedDescription} onChange={e => setFormData({...formData, detailedDescription: e.target.value})} className="w-full px-3 py-2 border rounded-lg h-48" placeholder="Full comprehensive description of the tour experience..."></textarea>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="space-y-4">
                        <div className="p-4 border rounded-lg bg-slate-50">
                          ...
                          <input type="text" value={formData.transportInfo?.type || ''} onChange={e => setFormData({...formData, transportInfo: {...formData.transportInfo, type: e.target.value}})} className="w-full px-3 py-2 border rounded-lg mb-2 text-sm" placeholder="Type (e.g. AC Volvo + Flight)" />
                          <input type="text" value={formData.transportInfo?.details || ''} onChange={e => setFormData({...formData, transportInfo: {...formData.transportInfo, details: e.target.value}})} className="w-full px-3 py-2 border rounded-lg text-sm" placeholder="Details (e.g. Airport transfers included)" />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-slate-700 mb-1">Meal Plan</label>
                          <input type="text" value={formData.mealPlan} onChange={e => setFormData({...formData, mealPlan: e.target.value})} className="w-full px-3 py-2 border rounded-lg text-sm" placeholder="e.g. MAP (Breakfast & Dinner)" />
                        </div>
                      </div>
                      ...
                      <div className="p-4 border rounded-lg bg-slate-50">
                        ...
                        <div className="space-y-3">
                          <input type="text" value={formData.hotelInfo?.[0]?.name || ''} onChange={e => handleArrayChange('hotelInfo', 0, {...formData.hotelInfo[0], name: e.target.value})} className="w-full px-3 py-2 border rounded-lg text-sm" placeholder="Hotel Name" />
                          <div className="flex gap-2">
                            <input type="number" min="1" max="5" value={formData.hotelInfo?.[0]?.rating || 3} onChange={e => handleArrayChange('hotelInfo', 0, {...formData.hotelInfo[0], rating: Number(e.target.value)})} className="w-20 px-3 py-2 border rounded-lg text-sm" placeholder="Stars" />
                            <input type="text" value={formData.hotelInfo?.[0]?.location || ''} onChange={e => handleArrayChange('hotelInfo', 0, {...formData.hotelInfo[0], location: e.target.value})} className="flex-1 px-3 py-2 border rounded-lg text-sm" placeholder="Location" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      {formData.itinerary.map((day, idx) => (
                        <div key={idx} className="p-4 border rounded-xl bg-slate-50 relative group">
                          ...
                          <textarea value={day.description || day.desc || ''} onChange={e => handleItineraryChange(idx, 'description', e.target.value)} className="w-full px-3 py-2 border rounded-lg text-sm mb-3 h-20 resize-none" placeholder="Describe the day's activities..."></textarea>
                          
                          <div className="grid grid-cols-2 gap-3">
                            <input type="text" value={day.meals || ''} onChange={e => handleItineraryChange(idx, 'meals', e.target.value)} className="w-full px-3 py-1.5 border rounded-lg text-sm" placeholder="Meals (e.g. Breakfast, Dinner)" />
                            <input type="text" value={day.accommodation || ''} onChange={e => handleItineraryChange(idx, 'accommodation', e.target.value)} className="w-full px-3 py-1.5 border rounded-lg text-sm" placeholder="Accommodation (Optional)" />
                          </div>
                        </div>
                      ))}
