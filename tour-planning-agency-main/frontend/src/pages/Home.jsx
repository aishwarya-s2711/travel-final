            ...
            <div className="flex flex-col md:flex-row gap-0">
              <div className="flex items-center gap-3 flex-1 px-5 py-5 border-b md:border-b-0 md:border-r" style={{ borderColor: '#f0ede6' }}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <input type="text" placeholder="Where to?" value={search.destination} onChange={e => setSearch({ ...search, destination: e.target.value })} className="w-full outline-none text-sm text-gray-900 bg-transparent placeholder-gray-400" />
                </div>
              </div>
              <div className="flex items-center gap-3 flex-1 px-5 py-5 border-b md:border-b-0 md:border-r" style={{ borderColor: '#f0ede6' }}>
      ...
      <section className="py-20 lg:py-24" style={{ background: '#fafaf8' }}>
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col md:flex-row items-center justify-between bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100"
          >
            <div className="flex-1 mb-8 md:mb-0 md:pr-12 text-center md:text-left">
              <h2 className="text-3xl lg:text-4xl font-light mb-4" style={{ fontFamily: 'Inter, sans-serif', color: '#0f172a' }}>
                Join Our <span style={{ color: '#7C3AED' }}>Travel Community</span>
              </h2>
              <p className="text-sm md:text-base" style={{ color: '#6b7280' }}>
                Subscribe to our newsletter to receive exclusive offers, luxury travel tips, and destination inspiration directly in your inbox.
              </p>
            </div>
            
            <div className="flex-1 w-full max-w-md">
              <form className="flex w-full" onSubmit={(e) => { e.preventDefault(); alert('Subscribed successfully!'); }}>
                <input 
                  type="email" 
                  placeholder="Enter your email address" 
                  required
                  className="flex-1 px-6 py-4 rounded-l-xl border border-gray-200 outline-none focus:border-[#7C3AED] transition-colors"
                />
                <button 
                  type="submit"
                  className="px-6 md:px-8 py-4 text-xs font-black tracking-widest uppercase rounded-r-xl transition-all duration-300"
                  style={{
                    background: 'linear-gradient(135deg, #7C3AED, #2563EB)',
                    color: '#0f172a',
                  }}
                  onMouseEnter={e => e.currentTarget.style.background = 'linear-gradient(135deg, #c9a86a, #8b5cf6)'}
                  onMouseLeave={e => e.currentTarget.style.background = 'linear-gradient(135deg, #7C3AED, #2563EB)'}
                >
                  Subscribe
                </button>
              </form>
              <p className="text-[11px] text-gray-400 mt-3 text-center md:text-left">
