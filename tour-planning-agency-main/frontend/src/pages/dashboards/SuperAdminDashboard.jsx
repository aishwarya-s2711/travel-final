    ...
    <div className="space-y-6">
      ...
      <div className="modern-card bg-white p-4 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 rounded-lg px-3 py-2 w-full max-w-sm">
          ...
          <input
            type="text"
            placeholder="Search booking ID, customer, or tour..."
            value={searchTerm}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="form-input text-sm p-2.5" placeholder="e.g. Hawaiian Beach Escape"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="form-input text-sm p-2.5" placeholder="e.g. Hawaii, USA"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="form-input text-sm p-2.5" placeholder="e.g. 5D/4N"
                    />
                  </div>
                  <div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="form-input text-sm p-2.5" placeholder="https://unsplash.com/..."
                    />
                  </div>
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="form-input text-sm p-2.5" placeholder="Spa Treatment, Beach Sunset, Sailing Cruise"
                    />
                  </div>
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="form-input text-sm p-2.5" placeholder="Flights, Breakfast, Tour Guide, Transfers"
                    />
                  </div>
              ...
              <form onSubmit={handleSave} className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" required value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} className="form-input text-sm" placeholder="e.g. Santorini" />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Country</label>
                    <input type="text" required value={form.country} onChange={e => setForm({ ...form, country: e.target.value })} className="form-input text-sm" placeholder="e.g. Greece" />
                  </div>
                  <div className="col-span-2">
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Image URL</label>
                  ...
                  <div>
                    ...
                    <input type="text" value={form.bestTime} onChange={e => setForm({ ...form, bestTime: e.target.value })} className="form-input text-sm" placeholder="e.g. May-Oct" />
                  </div>
                  <div className="col-span-2">
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Top Attractions (comma separated)</label>
                    <input type="text" value={form.attractions} onChange={e => setForm({ ...form, attractions: e.target.value })} className="form-input text-sm" placeholder="Oia Village, Red Beach" />
                  </div>
                  <div className="col-span-2">
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Brief Description</label>
                    <textarea rows={3} value={form.description} onChange={e => setForm({ ...form, description: e.target.value })} className="form-input text-sm" placeholder="Explain the destination details..." />
                  </div>
                </div>
                <div className="flex justify-end gap-2 pt-4 border-t border-slate-100">
            ...
            {activeReply === r.id && (
              <form onSubmit={(e) => handleReplySubmit(e, r.id)} className="pt-2 flex gap-2">
                <input
                  ...
                  className="form-input text-xs p-2.5 flex-1" placeholder="Write a response to this customer..."
              ...
              <form onSubmit={handleSave} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <input type="text" required value={form.title} onChange={e => setForm({ ...form, title: e.target.value })} className="form-input text-sm" placeholder="e.g. 5 things to do in..." />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Category</label>
                    <input type="text" required value={form.category} onChange={e => setForm({ ...form, category: e.target.value })} className="form-input text-sm" placeholder="e.g. Destinations" />
                  </div>
                  <div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input type="text" value={form.tags} onChange={e => setForm({ ...form, tags: e.target.value })} className="form-input text-sm" placeholder="Travel, Guide, Budget" />
                  </div>
                  <div className="col-span-2">
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea rows={4} value={form.content} onChange={e => setForm({ ...form, content: e.target.value })} className="form-input text-sm" placeholder="Write the main blog content..." />
                  </div>
                </div>
                <div className="flex justify-end gap-2 pt-4 border-t border-slate-100">
                  <button type="button" onClick={() => { setIsEditing(false); setIsAdding(false); }} className="btn btn-outline text-xs">Cancel</button>
